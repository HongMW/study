...
/*
	1. 배열이란?
		...
		필요하게 된다. 이런 방법은 비효율족이고 번거오운 코딩이 된다.
...
public class ArrayMain1 {
	...
	public static void main(String[] args) {
		...
		// 1) 배열의 메모리주소
		System.out.println(scores);				// 메로리주소 : 16진수
		System.out.println(scores.hashCode());	// 메로리주소 : 10진수
		System.out.println(scores.toString());	// 메로리주소 : 문자열(15진수)
		System.out.println();
		...
		//scores.length = 20; // 에러 : 배열의 length속성(필드)는 일기전용

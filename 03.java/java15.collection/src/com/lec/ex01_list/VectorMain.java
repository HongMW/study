...
//		boards.add(null);
		...
		boards.add(new Board (2, "제목2", "홍길동", "브라질 vs 대한민국!!"));
		boards.add(new Board (3, "제목3", "홍길동", "폴란드 vs 프랑스!!"));
		boards.add(new Board (4, "제목4", "홍길동", "일본 vs 크로아티아!!"));
		boards.add(new Board (5, "제목5", "홍길동", "아르헨티나 vs 호주!!"));

...
public class MethodMain {
	...
	public static void main(String[] args) {
		...
		// 3) method3는 자식객체에서 새롭개 추가된 메서드이기 때문에
		//	부모객체로 타입변환시에 삭제(짤리기)때문에 호출불가
		// parent.method3();
		System.out.println();
		
		// 2. 형변환이 되엇을 경우에 parent와 child가 동이타입인지 여부
		System.out.println(parent == child);		// true : child에서 형변환이 되었기때문에 동일 타입

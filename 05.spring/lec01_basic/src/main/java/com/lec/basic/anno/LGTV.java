...
/*
	@Autowired	: 주로 변수위에 설정하여 해당 타입의 객체를 찾아서 자동으로 주입
				  ...
				  NoSurchtBeanDefinitionException을 발생시킨다.
	@Qualifire	: 특정 객체의 이름을 이용하여 의존성주입을 할 때 사용한다.
	@inject		: @Autowired와 동일한 기능을 제공
	@Resource	: @Autowired와 @Qualifier기능을 결합한 에너테이션이다.
				  @Resource을 사용하려면 javax.annotation을 pom.xml에 등록해야 한다.
				  Maven Dependency를 등록해 주어야 한다.
*/

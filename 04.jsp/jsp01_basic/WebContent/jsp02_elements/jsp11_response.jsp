...
<!-- 
	...
	response객체는 request객체와 반대기능을 가기고 있다. request객체가 웹브라우저로 전송한
	...
	A. response객체의 메서드
		...
		f. setDateHeader(String name, long value) : name이라는 헤더에 long 타입의 date 값을 저장

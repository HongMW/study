...
<body>
	<div class="container" align="center">
		<h1>글 삭제하기</h1>
		<form action="boardDeleteMember.jsp" method="post">
			<table class="table table-bordered table-dark table-hover">
				<tr>
					<td>글번호</td>
					<td><input type="text" name="bno" class="form-control" value="<%= bno %>"/></td>
				</tr>
				<tr>
					<td>글제목</td>
					<td><input type="text" name="subject" class="form-control" value="<%= sbj %>" disabled></td>
				</tr>	
				<tr>
					<td>작성자</td>
					<td><input type="text" name="writer" class="form-control" value="<%= wrt %>" disabled></td>
				</tr>	
				<tr>
					<td>글내용</td>
					<td><input type="text" name="content" class="form-control" value="<%= ctnt %>" disabled></td>
				</tr>
			</table>
